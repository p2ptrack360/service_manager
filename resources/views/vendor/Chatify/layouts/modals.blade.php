...
{{--Create Group--}}
<div class="app-modal" data-name="create_group">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="create_group" data-modal='0'>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">Create Group and Add Users</div>
        
                            <div class="card-body">
                                <form method="POST" action="{{ route('group.create_and_add_users') }}">
                                    @csrf
        
                                    <div class="form-group">
                                        <label for="group_name" style="color: black">Group Name</label>
                                        <input type="text" class="messenger-search2" id="group_name" name="group_name" placeholder="Enter Group Name" required>
                                    </div>
                                    ...
                                    <button type="submit" class="app-btn a-btn-success">Create Group and Add Users</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="app-modal-footer">
                <a href="javascript:void(0)" class="app-btn cancel">Hide</a>
                {{-- <input type="submit" class="app-btn a-btn-success update" value="Save Changes" /> --}}
            </div>
        </div>
    </div>
