...
<head>
    ...
    <meta charset="utf-8" />
    <title>Impact | Service Manager</title>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-1">
                                            ...
                                            <h4 class="card-title mb-0 pt-3">Impact</h4>
                                        </div>
                                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" placeholder="Enter Impact Title" id="example-text-input">
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
