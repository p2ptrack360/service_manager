...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        ->groupBy('users.id','users.first_name','users.last_name','users.company_id', 'bu_id', 'name', 'email', 'designation_id', 'designation', 'email_verified_at', 'password', 'two_factor_secret', 'two_factor_recovery_codes', 'two_factor_confirmed_at', 'remember_token', 'created_at', 'updated_at', 'deleted_at', 'active_status', 'avatar', 'dark_mode', 'messenger_color')
